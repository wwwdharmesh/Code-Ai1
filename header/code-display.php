...
<head>
    ...
    <title>Header Code Display</title>
...
<body>
    ...
    <h1 style="text-align: center; margin-top: 26px;">Header Code</h1>
    ...
    <div class="container" id="codeContainer">
        <div class="box">
            <h3>HTML</h3>
            <pre id="htmlCode" contenteditable="false">Select a header to see the HTML code here...</pre>
        ...
        <div class="box">
            <h3>CSS</h3>
            <pre id="cssCode" contenteditable="false">Select a header to see the CSS code here...</pre>
        ...
        <div class="box">
            <h3>JavaScript</h3>
            <pre id="jsCode" contenteditable="false">Select a header to see the JavaScript code here...</pre>
    ...
    <script>
        ...
        fetch('headerCode.php?headerId=' + headerId)
