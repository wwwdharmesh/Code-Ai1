...
<head>
    ...
    <title>Login Code Display</title>
...
<body>
    ...
    <h1 style="text-align: center; margin-top: 100px;">Login Code</h1>
    ...
    <div class="container" id="codeContainer">
        <div class="box">
            <h3>HTML</h3>
            <pre id="htmlCode" contenteditable="false">Select a login to see the HTML code here...</pre>
        ...
        <div class="box">
            <h3>CSS</h3>
            <pre id="cssCode" contenteditable="false">Select a login to see the CSS code here...</pre>
        ...
        <div class="box">
            <h3>JavaScript</h3>
            <pre id="jsCode" contenteditable="false">Select a login to see the JavaScript code here...</pre>
    ...
    <script>
        ...
        const loginId = urlParams.get('loginId');  // Changed from headerId to loginId

        fetch('loginCode.php?loginId=' + loginId)  // Changed headerCode.php to loginCode.php
