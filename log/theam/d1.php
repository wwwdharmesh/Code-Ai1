...
<body>
    ...
    <section class="Home">
        <div class="home-info">
            ...
            <div class="btn-sci">
                <a href="../slog.php" class="btn">Simple -</a>
                <a href="../slider.php" class="btn2">Advance</a> 
            </div>
            <div class="sci">
                <a href="#"><i class='bx bxl-github'></i></a>
                <a href="#"><i class='bx bxl-linkedin'></i></a>
                <a href="#"><i class='bx bxl-facebook'></i></a>
                <a href="https://wa.me/8780754812?text=Hello%2C%20I%20am%20interested!" target="_blank"><i class='bx bxl-whatsapp'></i></a>
            </div>
        </div>
